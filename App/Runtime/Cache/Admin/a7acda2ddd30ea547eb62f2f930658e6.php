...
<div class="tab-div">
    ...
    <div id="tabbody-div">
      <form method="POST" action="/E-Cshop/Admin/Goods/edit/id/2/p/1.html" style="margin:5px" 
        ...
        <div class="content" style="display:block">
          ...
          value="<?php echo ($data["goods_name"]); ?>"/>
          </p>
          <p>主分类：
            <select name="cat_id">
          ...
          <p>市场价：￥ <input type="text" name="market_price" 
          value="<?php echo ($data["market_price"]); ?>"/></p>
        ...
        <!--商品描述-->
        <div class="content">          
            <p><textarea id="goods_desc" name="goods_desc"><?php echo ($data["goods_desc"]); ?></textarea></p>
        </div>
        <!--会员价格-->
        <div class="content">
