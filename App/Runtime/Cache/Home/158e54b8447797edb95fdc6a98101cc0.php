...
<!-- 页面头部 start -->
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="index.html"><img src="/E-Cshop/Public/Home/images/logo.png" alt="京西商城"></a></h2>
...
<form action="/E-Cshop/Cart/order.html" method="POST" name="order_form">
	<!-- 主体部分 start -->
